          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6 relative z-10">
            <div>
              ...
              <h1 className="text-3xl md:text-5xl font-black text-white tracking-tighter italic">
                {query ? `"${query}" Sonuçları` : 'İŞLETMELER'}
              </h1>
              <p className="text-slate-400 mt-2 font-medium">Fethiye'deki tüm restoran, otel ve hizmet noktalarını keşfedin.</p>
            </div>
            {query && (
              <Link href="/isletmeler" className="px-8 py-3 bg-white/5 hover:bg-white/10 text-white rounded-xl text-xs font-bold transition-all border border-white/10">
                Tüm İşletmelere Dön
              </Link>
            )}
          </div>

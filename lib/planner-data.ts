...
export const ALL_ACTIVITIES: ActivityItem[] = [
  ...
  { id: 'butterfly', title: 'Kelebekler Vadisi', description: 'Sarp kayalıklar arasında saklı cennet.', image: 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=800', category: 'doga', location: 'Faralya', transport: 'boat', isPopular: true },
  ...
  { id: 'cennet', title: 'Cennet Koyu', description: 'Sadece denizden ulaşılabilen bakir koy.', image: 'https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?w=800', category: 'doga', location: 'Faralya', transport: 'boat' },
  { id: 'soguksu', title: 'Soğuk Su Koyu', description: 'Denizin altından çıkan tatlı su kaynağı.', image: 'https://images.unsplash.com/photo-1544833058-e70f9ca25c17?w=800', category: 'doga', location: 'Kayaköy', transport: 'boat' },
  { id: 'akvaryum', title: 'Akvaryum Koyu', description: 'Cam gibi berrak sular ve sualtı dünyası.', image: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800', category: 'doga', location: 'Fethiye', transport: 'boat' },
  ...
  { id: 'gemiler_adasi', title: 'Gemiler Adası', description: 'Bizans kiliseleri ve antik liman.', image: 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=800', category: 'tarih', location: 'Kayaköy', transport: 'boat', isPopular: true },
  ...
  { id: 'tekne_turu', title: '12 Adalar Tekne Turu', description: 'Mavi turun vazgeçilmez rotası.', image: 'https://images.unsplash.com/photo-1544833058-e70f9ca25c17?w=800', category: 'deneyim', location: 'Merkez Liman', transport: 'boat' },
  ...
  { id: 'kano', title: 'Kano & Paddle Board', description: 'Sessiz koylarda kürek çekme.', image: 'https://images.unsplash.com/photo-1544833058-e70f9ca25c17?w=800', category: 'deneyim', location: 'Ölüdeniz', transport: 'boat' },
